...
from data_imports import prepare_training_data, bundesliga_season_data  # <- your code
...
full, feature_cols = build_training_table(bundesliga_season_data, target_column="Points")
