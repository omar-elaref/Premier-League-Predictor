...
\begin{itemize}
    ...
    \item \textbf{Head-to-head history}: Last $k_{h2h}=4$ encounters between each team pair, using the same 7-dimensional representation. Also encoded by a GRU to capture matchup-specific dynamics and historical dominance patterns.
\end{itemize}
...
We optimize the model using Adam with a learning rate of $3\times10^{-4}$ and weight decay of $1\times10^{-4}$.
...
\nocite{armantee2025,nyquist2017deep,dixon1997modelling,constantinou2012pifootball,hubacek2019learning, footballdata, andrew2007scalable,Framework-for-Sport-Predictions,Chandra:81}
